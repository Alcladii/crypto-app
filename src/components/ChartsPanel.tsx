...
import {
  CarouselChartsContext,
  CarouselChartsContextProps,
} from "../contexts/CarouselChartsContext";
...
export const ChartsPanel = () => {
  ...
  const daysInURL = queryParams.days as string

  const { selectedCoinIds, selectedCoinData } = useContext(
    CarouselChartsContext
  ) as CarouselChartsContextProps;
